...
3. Set up your .env files 
    1. Create a copy of the frontend and backend .env files (ask the TL or PM for access) and place them at the same level as the .env.example file in __frontend/__ and __backend/__.
