/**
 * Adapted Simple Floating edge code
...
function SimpleFloatingEdge({ id, source, data, target, markerEnd, style }) {
    ...
    <>
        ...
        <EdgeLabelRenderer>
            <div className={`absolute -translate-1/2`} style={{ transform:`translate(${labelX}px, ${labelY}px)`}}>
                {data?.label != undefined ? (
                    <span className='font-bold'>x{data.label}</span>
                    ):(
                    <></>
                    )
                }
